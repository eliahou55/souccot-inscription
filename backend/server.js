...
<body style="margin:0;padding:0;font-family:Arial,sans-serif;background:#f4f4f4;">
  <table width="100%" cellpadding="0" cellspacing="0" style="max-width:600px;margin:0 auto;background:#fff;">
    <tr>
      <td style="background:#1a6b2f;padding:25px;text-align:center;">
        <h1 style="color:#fff;margin:0;font-size:22px;">LOISIRÉL SOUCCOT 2026</h1>
        <p style="color:#d7f5da;margin:5px 0 0;">Hôtel Millenium Charles de Gaulle</p>
      </td>
    </tr>
    <tr>
      <td style="padding:30px;">
        ...
        <h3 style="color:#1a6b2f;border-bottom:2px solid #1a6b2f;padding-bottom:6px;">Récapitulatif</h3>
        <table width="100%" cellpadding="8" cellspacing="0" style="border-collapse:collapse;font-size:14px;">
          <tr style="background:#eef9ec;">
          ...
          <tr style="background:#1a6b2f;">
            <td style="border:1px solid #1a6b2f;color:#fff;padding:10px;"><strong>TOTAL</strong></td>
            <td style="border:1px solid #1a6b2f;color:#fff;padding:10px;"><strong>${finalTotal}€</strong></td>
          </tr>
          <tr>
    ...
    <tr>
      <td style="background:#eef9ec;padding:15px;text-align:center;font-size:12px;color:#888;">
...
function buildOrganizerEmail(data, finalTotal) {
    ...
    const membresHTML = membres.map((m, i) =>
        `<tr style="${i % 2 === 0 ? 'background:#eef9ec;' : ''}">
...
<body style="margin:0;padding:0;font-family:Arial,sans-serif;background:#f4f4f4;">
  <table width="100%" cellpadding="0" cellspacing="0" style="max-width:600px;margin:0 auto;background:#fff;">
    <tr>
      <td style="background:#1a6b2f;padding:20px;text-align:center;">
    ...
    <tr>
      <td style="padding:25px;">
        ...
        ${membres.length > 0 ? `
        <h3 style="color:#1a6b2f;margin-top:20px;">Membres de la famille</h3>
